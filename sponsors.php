...
<link rel="stylesheet" href="assets/css/custom.min.css">
	...
	<script id="_carbonads_projs" type="text/javascript" src="//srv.carbonads.net/ads/CKYIE23N.json?segment=placement:bootswatchcom&amp;callback=_carbonads_go"></script>
</head>
...
<body>
	<div class="navbar navbar-expand-lg fixed-top navbar-dark bg-primary">
		<div class="container">
			<!-- Logo header-->
			<a href="../" class="navbar-brand"> <img src="assets/images/light 4 colour Amrut Cup.svg" width="100px"> </a>
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" id="themes">Teams <span class="caret"></span></a>
	...
	<div class="bs-docs-section">
		<img style="width: 100%; display: block;" src="assets/images/Baps Charities.svg" alt="Card image">
		<div align="center">
		<img style="width: 50%; display: block;" src="assets/images/Royal Pest Control.svg" alt="Card image">
       	<img style="width: 50%; display: block;" src="assets/images/PRAS Builders.png" alt="Card image">
		<img style="width: 50%; display: block;" src="assets/images/Prayas-Construction-Logo.png" alt="Card image">
	</div>
	  <footer id="footer">
        <div class="row">
          <div class="col-lg-12">
